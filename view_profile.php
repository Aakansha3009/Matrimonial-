...
$q="SELECT * FROM photos WHERE cust_id = $id";

$result2 = mysqlexec1($q);
if($result2){
   	 	...
   	 	<div class="col_3">
   	        <div class="col-sm-4 row_2">
				<div class="flexslider">
					 <ul class="slides">
						<li data-thumb="<?php echo $pic1;?>">
							<img src="<?php echo $pic1; ?>" />
						</li>
						<li data-thumb="<?php echo $pic2;?>">
							<img src="<?php echo $pic2;?>" />
						</li>
						<li data-thumb="<?php echo $pic3;?>">
							<img src="<?php echo $pic3;?>" />
						</li>
						<li data-thumb="<?php echo $pic4;?>">
