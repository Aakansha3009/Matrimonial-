  ...
  <div class="container">
   <div class="breadcrumb1">
     <ul>
        ...
        <li class="current-page"><b>Find your match!</b></li>
     </ul>
   </div>
  ...
  <div class="form_but1">
	...
	<div class="col-sm-7 form_radios">
	  <div class="col-sm-5 input-group1">
        <input class="form-control has-dark-background" name="agemin" id="slider-name" placeholder="Min age 18" type="text" required=""/>
      </div>
      
      <div class="col-sm-5 input-group1">
        <input class="form-control has-dark-background" name="agemax" id="slider-name" placeholder="Max age 40" type="text" required=""/>
      </div>
      <div class="clearfix"> </div>
	</div>
	<div class="clearfix"> </div>
